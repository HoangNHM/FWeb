...
export const CIRCULAR_ITEMS: MenuItem[] = [
  ...
  {id: 3, name: 'Marketing & Sales', nav: 'marketing-sales'},
  {id: 2, name: 'Product & Service Management', nav: 'product-service-management'},
  {id: 1, name: 'Strategic Management', nav: 'strategic-management'}
];
